...
export default function Footer() {
    return (
        <>
            <section className="h-auto py-10 border-t border-primary-blue-300/80 bg-linear-to-b from-primary-blue-500 to-primary-blue-300/30 text-primary-blue-100">
                <div className="flex flex-row items-center w-full h-full text-center text-3xl text-shadow-lg text-primary-blue-50 max-sm:flex-col max-sm:space-y-5">
                    {/* Left Third - Email */}
                    ...
                    {/* Center Section - Name */}
                    <h1 className="flex-2 text-5xl -rotate-z-1 font-bold hover:rotate-z-0 active:scale-105 duration-300 hover:cursor-pointer active:rotate-x-360 hover:text-primary-purple-400">
                        Samuel Mac Klosky
                    </h1>
